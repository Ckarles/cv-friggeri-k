...
% Modified by:
% Ckarles
% https://gitlab.com/Ckarles/cv-friggeri-k.git
%
% License:
...
\documentclass[a4paper]{cv-friggeri-k}
...
% Add `nobackground` to not show the background

\usepackage{fontawesome} % needed to print glyphs for email, cell phone etc.
